      ...
      <Table sx={{ minWidth: 650, backgroundColor:"#5499C7" }} className={classes.table} aria-label="simple table">
        ...
        <TableBody>
          {currentItems?.map((ticket, index) => (
            <TableRow key={ticket._id} style={{backgroundColor:  '#fff'}}>
              ...
              <TableCell align="center"><Button disabled={ticket.isDelete}  variant="contained" color="primary" onClick={()=>{handleClickOpen(ticket._id)}} style={{display:ticket.Email===email?"block":"none" }}> Edit</Button></TableCell>
              
             
              <TableCell align="center"><Button disabled={ticket.isDelete}  variant="contained" color="error" onClick={()=>{daleteticket(ticket._id)}} style={{display:ticket.Email===email?"block":"none" }}> Delete</Button></TableCell>
            </TableRow>
